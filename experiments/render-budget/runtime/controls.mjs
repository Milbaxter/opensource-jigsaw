...
export async function makeControls(){setEncodingDeadline(Date.now()+10*60000);
 const dir=path.join(ROOT,'generated','controls');await fs.mkdir(dir,{recursive:true});const cases=[];
 ...
 await json(path.join(ROOT,'execution','control-inputs.json'),cases);return cases;
}
